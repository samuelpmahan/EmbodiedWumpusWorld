...
import {teachingSet,transferSet,renderLesson,gradeAnswers,gradeCertificate,resolveCertificate} from '../../src/teaching.js';
...
else if(command==='solve')console.log(JSON.stringify(resolveCertificate(set(phase)[4].spec,JSON.parse(readFileSync(argument,'utf8'))),null,2));
else throw Error('Commands: lesson [phase], packet [phase], grade file [phase], certificate file [phase], solve assignments.json [phase]');
